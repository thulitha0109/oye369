...
const projects: Project[] = [
  {
    ...
    category: "events",
    description: "A high-profile corporate event bringing together 500+ industry leaders for networking and innovation discussions.",
  ...
  },
  {
    ...
    category: "agro",
    description: "Converting 50 acres to sustainable organic farming with modern irrigation and crop rotation systems.",
      ...
      <div className="max-w-8xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Our <span className="bg-gradient-to-r from-primary to-red-600 bg-clip-text text-transparent">Portfolio</span>
          </h2>
